...
def LSA_CVSIM_Superimposer():
    ...
    colorbgr.place(x = 0, y = 0, width =7000, height = 2000)  
    CVType_Label  = Label(Fenster,text="Superimpose up to 50 LSA-CVs by choosing the CV-Type number 1 to 12", bg = '#D5E88F', font = ('Arial',12,'bold'))
    CVType_Label.place(x = 25, y = 15)    
    Lab1 = Label(Fenster,text=" LSACV-Type Number", bg = '#D5E88F')
...
def LSA_CVFIT_Superimposer():
    ...
    colorbgr = Label(Fenster, text= "", bg = '#D5E88F')
    colorbgr.place(x = 0, y = 0, width =7000, height = 2000)  
    CVType_Label  = Label(Fenster,text="Superimpose up to 50 CVs by choosing the CV-Type number 1 to 12", bg = '#D5E88F', font = ('Arial',12,'bold'))
    CVType_Label.place(x = 25, y = 15)    
