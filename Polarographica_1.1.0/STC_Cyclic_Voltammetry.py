...
def STC_Eingabe_CV_Simulator():
    ...
    if FIT == 0:
        Steptime_Label = Label(Fenster,text="Steptime [s]*",bg = '#D5E88F')
    ...
    if FIT == 1:
        colorbox8 = Label(Fenster,text="This field is inactive for your desired calculation.", bg = '#D5E88F')
...
#========================================================================
        ...
        if FIT == 0:
            ...
            Steps_Up         = (float(Steps_Up_Eingabe.get()))
            Steps_Down       = (float(Steps_Down_Eingabe.get()))
